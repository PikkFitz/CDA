DROP DATABASE IF EXISTS Evaluation_Creation_BDD_Exercice_2_Papyrus;

CREATE DATABASE Evaluation_Creation_BDD_Exercice_2_Papyrus;

USE Evaluation_Creation_BDD_Exercice_2_Papyrus;
...
CREATE TABLE `fournis` (
  ...
  `satisf` tinyint(2) CHECK (`satisf` >=0 AND `satisf` <=10),
  PRIMARY KEY (`numfou`)
);
...
CREATE INDEX `entcom_numero_fournisseur` 
ON `entcom` (`numfou` ASC);


-- GESTION DES UTILISATEURS ---------------------------------------------------------------------------

-- Trois utilisateurs util1, util2, util3 pour la base papyrus --

CREATE USER 'util_eval_1'@'localhost' IDENTIFIED BY 'mdp_util1';
CREATE USER 'util_eval_2'@'localhost' IDENTIFIED BY 'mdp_util2';
CREATE USER 'util_eval_3'@'localhost' IDENTIFIED BY 'mdp_util3';


-- util1 doit pouvoir effectuer toutes les actions --

GRANT ALL PRIVILEGES ON Evaluation_Creation_BDD_Exercice_2_Papyrus.* TO 'util_eval_1'@'localhost';


-- util2 ne peut que sélectionner les informations dans la base --

GRANT SELECT ON Evaluation_Creation_BDD_Exercice_2_Papyrus.* TO 'util_eval_2'@'localhost';


-- util3 n'a aucun droit sur la base de données, sauf d'afficher la table fournis --

GRANT SELECT ON Evaluation_Creation_BDD_Exercice_2_Papyrus.fournis TO 'util_eval_3'@'localhost';